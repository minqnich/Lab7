...
public class BucketController {
    ...
    public ResponseEntity<?> uploadFile(@RequestPart(value = "file")
        ...
        return
                ResponseEntity.ok(this.cloudStorageHelper.getImageUrl(file,"imageupload-669fb.appspot.com"));
    }
    ...
    public ResponseEntity<?> uploadFileComponent(@RequestPart(value = "image")
        MultipartFile file) throws IOException, ServletException {
            return
                    ResponseEntity.ok(this.cloudStorageHelper.getStorageFileDto(file,"imageupload-669fb.appspot.com"));
    }
}
